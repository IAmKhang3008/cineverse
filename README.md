...
<div align="center">
  ...
  [![Vercel Deployment](https://img.shields.io/badge/Vercel-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://cineverse-cinema.vercel.app)
  [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
  [![React](https://img.shields.io/badge/React-18.2.0-61DAFB?logo=react)](https://reactjs.org/)
  [![TypeScript](https://img.shields.io/badge/TypeScript-5.0-3178C6?logo=typescript)](https://www.typescriptlang.org/)
  
  <p>
    <a href="https://cineverse-cinema.vercel.app">🌐 Live Demo</a> •
...
🌐 **Website chính thức:** [https://cineverse-cinema.vercel.app](https://cineverse-cinema.vercel.app)
...
- **Ken Burns Effect** – Hiệu ứng zoom nhẹ trên banner tạo cảm giác điện ảnh
...
- **Hero Banner Netflix-style** – Banner chính với hiệu ứng fade và thumbnail
...
- **Danh sách tập** – Hiển thị tập đã xem (xanh lá), tập hiện tại (đỏ), tập chưa xem (xám)
- **Chọn Audio** – Vietsub, Thuyết minh, Lồng tiếng
- **Chất lượng hiển thị** – Hiển thị đúng 1080p, 720p thay vì "Tự động"

### ⭐ Quản lý cá nhân
- **Yêu thích** – Lưu danh sách phim yêu thích với pop-up thông báo
- **Lịch sử xem** – Xem lại những phim đã xem, tiếp tục từ chỗ dừng
- **Hồ sơ cá nhân** – Tùy chỉnh avatar, tên hiển thị, email, mật khẩu
- **Avatar mặc định** – Hình profile với hiệu ứng trong suốt khi ở banner
...
- **Cast hình tròn** – Diễn viên hiển thị hình tròn trên mobile, hình chữ nhật trên desktop
...
- [Vercel](https://vercel.com) – Nền tảng hosting
...
<div align="center">
  ...
  <a href="https://cineverse-cinema.vercel.app">
    <img src="https://img.shields.io/badge/Visit%20Website-cineverse--cinema.vercel.app-red?style=for-the-badge&logo=vercel" alt="Visit Website">
  </a>
</div>
...
- 🌐 **Live Demo:** [https://cineverse-cinema.vercel.app](https://cineverse-cinema.vercel.app)
