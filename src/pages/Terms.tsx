...
export default function Terms() {
  ...
  return (
    <div className="max-w-[1280px] mx-auto px-6 py-12">
      <h1 className="text-3xl font-heading font-bold text-white tracking-wider mb-12 flex items-center gap-3">
      ...
      <div className="flex flex-col md:flex-row gap-12">
        ...
        <div className="w-full md:w-64 flex-shrink-0">
          <div className="sticky top-24 bg-[#121212] rounded-2xl border border-white/5 p-4 flex flex-col gap-2 shadow-[0_10px_30px_rgba(0,0,0,0.2)]">
            <button 
              onClick={() => scrollToSection('terms')}
              className={`text-left px-4 py-3 rounded-xl font-medium transition-all ${activeSection === 'terms' ? 'bg-[#E50914] text-white shadow-[0_4px_14px_rgba(229,9,20,0.3)]' : 'text-[#A0A0A0] hover:bg-[#2A2A2A] hover:text-white'}`}
            >
              Điều khoản sử dụng
            </button>
            <button 
              onClick={() => scrollToSection('privacy')}
              className={`text-left px-4 py-3 rounded-xl font-medium transition-all ${activeSection === 'privacy' ? 'bg-[#E50914] text-white shadow-[0_4px_14px_rgba(229,9,20,0.3)]' : 'text-[#A0A0A0] hover:bg-[#2A2A2A] hover:text-white'}`}
            >
              Chính sách bảo mật
            </button>
            <button 
              onClick={() => scrollToSection('dmca')}
              className={`text-left px-4 py-3 rounded-xl font-medium transition-all ${activeSection === 'dmca' ? 'bg-[#E50914] text-white shadow-[0_4px_14px_rgba(229,9,20,0.3)]' : 'text-[#A0A0A0] hover:bg-[#2A2A2A] hover:text-white'}`}
            >
              Khiếu nại bản quyền (DMCA)
            </button>
            <button 
              onClick={() => scrollToSection('contact')}
              className={`text-left px-4 py-3 rounded-xl font-medium transition-all ${activeSection === 'contact' ? 'bg-[#E50914] text-white shadow-[0_4px_14px_rgba(229,9,20,0.3)]' : 'text-[#A0A0A0] hover:bg-[#2A2A2A] hover:text-white'}`}
            >
              Liên hệ hỗ trợ
            </button>
          </div>
        ...
        {/* Content Area */}
        <div className="flex-grow bg-[#121212] rounded-3xl border border-white/5 p-8 md:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.3)] text-[#A0A0A0] leading-relaxed">
          <div className="space-y-16">
            {/* ĐIỀU KHOẢN SỬ DỤNG */}
            <section id="terms" className="scroll-mt-24">
              <h2 className="text-2xl font-heading font-bold text-white mb-4">ĐIỀU KHOẢN SỬ DỤNG</h2>
              <p className="mb-6 italic text-[#A0A0A0]/70">Cập nhật lần cuối: 23/02/2026</p>
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-heading font-semibold text-white mb-2">1. Tài khoản người dùng</h3>
                ...
                <div>
                  <h3 className="text-xl font-heading font-semibold text-white mb-2">2. Quyền sở hữu trí tuệ</h3>
                  <p className="mb-2">
                ...
                <div>
                  <h3 className="text-xl font-heading font-semibold text-white mb-2">3. Hành vi bị cấm</h3>
                ...
                <div>
                  <h3 className="text-xl font-heading font-semibold text-white mb-2">4. Giới hạn trách nhiệm pháp lý</h3>
                ...
                <div>
                  <h3 className="text-xl font-heading font-semibold text-white mb-2">5. Thay đổi và chấm dứt dịch vụ</h3>
                  <p>
            ...
            <section id="privacy" className="scroll-mt-24">
              <h2 className="text-2xl font-heading font-bold text-white mb-6">CHÍNH SÁCH BẢO MẬT</h2>
              <p className="mb-6">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-heading font-semibold text-white mb-2">1. Thông tin chúng tôi thu thập</h3>
                ...
                <div>
                  <h3 className="text-xl font-heading font-semibold text-white mb-2">2. Mục đích sử dụng thông tin</h3>
                ...
                <div>
                  <h3 className="text-xl font-heading font-semibold text-white mb-2">3. Chia sẻ thông tin</h3>
                ...
                <div>
                  <h3 className="text-xl font-heading font-semibold text-white mb-2">4. Cookie</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-xl font-heading font-semibold text-white mb-2">5. Bảo mật dữ liệu</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-xl font-heading font-semibold text-white mb-2">6. Quyền của người dùng</h3>
                  <p>
            ...
            <section id="dmca" className="scroll-mt-24">
              <h2 className="text-2xl font-heading font-bold text-white mb-6">KHIẾU NẠI BẢN QUYỀN (DMCA)</h2>
              <p className="mb-6">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-heading font-semibold text-white mb-2">1. Cách thức gửi khiếu nại</h3>
                  <p className="mb-2">
                    Để khiếu nại có hiệu lực, vui lòng cung cấp đầy đủ các thông tin sau (theo Điều 512, DMCA) qua email: <strong className="text-white">copyright@cineverse.com</strong> hoặc thư bảo đảm về địa chỉ văn phòng của chúng tôi.
                  </p>
                ...
                <div>
                  <h3 className="text-xl font-heading font-semibold text-white mb-2">2. Xử lý khiếu nại</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-xl font-heading font-semibold text-white mb-2">3. Phản hồi từ người dùng (Phản đối)</h3>
                  <p>
            ...
            {/* Liên hệ hỗ trợ */}
            <section id="contact" className="bg-[#1A1A1A] p-8 rounded-2xl border border-white/5 scroll-mt-24">
              <h2 className="text-2xl font-heading font-bold text-white mb-4">Liên hệ hỗ trợ</h2>
              <p className="mb-6">Mọi thắc mắc về Điều khoản, Chính sách Bảo mật hoặc Khiếu nại Bản quyền, vui lòng liên hệ:</p>
              <ul className="space-y-4">
                <li className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <strong className="text-white">support@cineverse.com</strong>
                  </div>
                </li>
                <li className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm text-[#A0A0A0]">Địa chỉ</p>
                    <strong className="text-white">Tòa nhà Cineverse, Quận 1, TP. Hồ Chí Minh, Việt Nam</strong>
                  </div>
                </li>
              </ul>
            </section>
