    ...
    <footer className="bg-[#1A1A1A]  border-t border-[#2A2A2A]  pt-20 pb-10 mt-20 transition-colors duration-300">
      ...
      <div className="max-w-[1280px] mx-auto px-6 border-t border-[#2A2A2A]  pt-8 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="flex items-center gap-4 mt-4 md:mt-0">
          <a href="#" className="w-10 h-10 rounded-full bg-[#2A2A2A]  flex items-center justify-center text-white  hover:bg-[#FF0000] transition-colors" title="Youtube">
            <Youtube className="w-5 h-5" />
          </a>
          <a href="#" className="w-10 h-10 rounded-full bg-[#2A2A2A]  flex items-center justify-center text-white  hover:bg-[#1877F2] transition-colors" title="Facebook">
            <Facebook className="w-5 h-5" />
          </a>
          <a href="#" className="w-10 h-10 rounded-full bg-[#2A2A2A]  flex items-center justify-center text-white  hover:bg-[#00f2fe] transition-colors" title="Tiktok">
